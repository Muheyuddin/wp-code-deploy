...
class WeDesignTech_Widget_Base_Popup_Box {
	...
	public function create_elementor_controls($elementor_object) {
		...
		$elementor_object->start_controls_section( 'wdt_section_settings', array(
			...
			$elementor_object->add_control( 'custom_class', array(
				'label'       => esc_html__( 'Custom Class', 'wdt-elementor-addon' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => 'custom-class',
				'description' => esc_html__('Provide Custom class here', 'wdt-elementor-addon'),
			));
	...
	public function render_html($widget_object, $settings) {
		...
		$pb_settings = array (
			...
			'popup_class'       => 'wdt-popup-box-window wdt-popup-box-window-'.esc_attr($module_id).' '.esc_attr($settings['animation_type']).' '.esc_attr($settings['custom_class']),
