...
class WeDesignTech_Widget_Elementor_Speed_Test extends WeDesignTech_Elementor_Widget_Base {
	...
	function __construct( array $data = [], $args = null ) {
        ...
        $this->widget_base = wedesigntech_widget_base_speed_test();
...
wedesigntech_elementor_get_elementor_widgets_manager()->register( new WeDesignTech_Widget_Elementor_Speed_Test() );