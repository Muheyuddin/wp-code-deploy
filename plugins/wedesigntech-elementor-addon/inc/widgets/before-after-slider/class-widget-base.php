...
class WeDesignTech_Widget_Base_Before_After_Slider {
	...
	public function init_scripts() {
		return array (
            'jquery-ui.min' =>  WEDESIGNTECH_ELEMENTOR_ADDON_DIR_URL.'inc/widgets/before-after-slider/assets/js/jquery-ui.min.js',
    ...
    public function render_html($widget_object, $settings){
        ...
        $output = '';
            $output .=  ' <div class="wdt-before-after-slider-container"> ';
                ...
                $output .= '<input type="range" min="1" max="100" value="50" class="wdt-before-after-sliders" name="wdt_before_after_slider" id="wdt_before_after_slider">';
