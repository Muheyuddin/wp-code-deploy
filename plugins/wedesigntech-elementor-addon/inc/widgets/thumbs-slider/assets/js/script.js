 (function ($) {
    ...
    const wdtThumbSliderWidgetHandler = function($scope, $) {
      ...
      const $moduleThumbId = $swiperThumbItem.data('wrapper-thumb-class');
        ...
        const $autoplay_speed	 	= ($thumb_content_option['autoplay_speed'] !== undefined && $thumb_content_option['autoplay_speed'] != '') ? parseInt($thumb_content_option['autoplay_speed']) : 20000;
