  ...
  const wdtTabsWidgetHandlerInit = function($scope) {
    ...
    $self.init = function() {
      ...
      $window.on('resize', () => {
        ...
        // Track the active tab before the reinitialization
        let $activeTabId = $scope.find('.wdt-tabs-list li.wdt-active a').attr('href');
        ...
        if($device === 'mobile' || $device === 'mobile_extra') {
          ...
          setTimeout(function () {
            ...
            if ($activeTabId) {
              $scope.find('.wdt-tabs-list a[href="' + $activeTabId + '"]').parent().addClass('wdt-active');
              $scope.find($activeTabId).show();
            } else {
          ...
          setTimeout(function () {
            ...
            // Reapply the active tab after reinitialization
            if ($activeTabId) {
              $scope.find('.wdt-tabs-list a[href="' + $activeTabId + '"]').parent().addClass('wdt-active');
              $scope.find($activeTabId).show();
            } else {
