...
class WeDesignTech_Widget_Base_Pricing_Table {
	...
	function __construct() {
		...
		// Group 1 content positions
			$group1_content_position_elements = array(
				...
				'icons'    => esc_html__( 'Icons', 'wdt-elementor-addon'),
	...
	public function create_elementor_controls($elementor_object) {
		...
		// Icons
			...
			$elementor_object->start_controls_section( 'wdt_section_icons', array(
				'label' => esc_html__( 'Icons', 'wdt-elementor-addon'),
			) );
				
				$icons_repeater = new \Elementor\Repeater();

				$icons_repeater->add_control( 'media_icon_item', array(
					'label'            => esc_html__( 'Icon', 'wdt-elementor-addon' ),
					'type'             => \Elementor\Controls_Manager::ICONS,
				...
				$elementor_object->add_control( 'icons_content', array(
					'type'        => \Elementor\Controls_Manager::REPEATER,
					'label'       => esc_html__('Icon Items', 'wdt-elementor-addon'),
					'description' => esc_html__('Description', 'wdt-elementor-addon' ),
					'fields'      => $icons_repeater->get_controls(),
					'default' => array (
						array (
							'media_icon_item' => array( 'value' => 'fas fa-star', 'library' => 'fa-solid' )
						),
						array (
							'media_icon_item' => array( 'value' => 'fas fa-circle', 'library' => 'fa-solid' )
						),
						array (
							'media_icon_item' => array( 'value' => 'fas fa-check', 'library' => 'fa-solid' )
						)
					)
				) );
		...
		// Styles
			...
			// Icons
				$this->cc_style->get_style_controls($elementor_object, array (
					'slug' => 'icons',
					'title' => esc_html__( 'Icons', 'wdt-elementor-addon' ),
					'styles' => array (
						'alignment' => array (
							'field_type' => 'alignment',
							'selector' => array (
								'{{WRAPPER}} .wdt-pricing-table-holder .wdt-pricing-table-icons-content .wdt-pricing-table-icons-content-list li' => 'text-align: {{VALUE}}; justify-content: {{VALUE}}; justify-items: {{VALUE}};'
							),
							'condition' => array ()
						),
						'margin' => array (
							'field_type' => 'margin',
							'selector' => array (
								'{{WRAPPER}} .wdt-pricing-table-holder .wdt-pricing-table-icons-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							),
							'condition' => array ()
						),
						'padding' => array (
							'field_type' => 'padding',
							'selector' => array (
								'{{WRAPPER}} .wdt-pricing-table-holder .wdt-pricing-table-icons-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
							),
							'condition' => array ()
						),
						'tabs' => array (
							...
							'tab_items' => array (
								'normal' => array (
									...
									'styles' => array (
										'background' => array (
											'field_type' => 'background',
											'selector' => '{{WRAPPER}} .wdt-pricing-table-holder .wdt-pricing-table-icons-content',
											'condition' => array ()
										),
										'border' => array (
											'field_type' => 'border',
										...
										'border_radius' => array (
											'field_type' => 'border_radius',
											'selector' => array (
												'{{WRAPPER}} .wdt-pricing-table-holder .wdt-pricing-table-icons-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
											),
											'condition' => array ()
										)
									)
								...
								'hover' => array (
									...
									'styles' => array (
										'color' => array (
											'field_type' => 'color',
											'selector' => array (
												'{{WRAPPER}} .wdt-pricing-table-holder:hover .wdt-pricing-table-icons-content' => 'color: {{VALUE}};'
											),
											'condition' => array ()
										),
										'background' => array (
											'field_type' => 'background',
											'selector' => '{{WRAPPER}} .wdt-pricing-table-holder:hover .wdt-pricing-table-icons-content',
											'condition' => array ()
										),
										'border' => array (
											'field_type' => 'border',
										...
										'border_radius' => array (
											'field_type' => 'border_radius',
											'selector' => array (
												'{{WRAPPER}} .wdt-pricing-table-holder:hover .wdt-pricing-table-icons-content' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
											),
											'condition' => array ()
										)
									)
						...
						'color' => array (
							...
							'selector' => array (
								'{{WRAPPER}} .wdt-pricing-table-holder .wdt-pricing-table-icons-content .wdt-pricing-table-icons-content-list li:after' => 'border-top-color: {{VALUE}};'
							),
							'condition' => array (
								'template!' => 'list'
							),
						...
						'weight' => array (
							...
							'size_units' => array ( 'px' ),
							'selector' => array (
								'{{WRAPPER}} .wdt-pricing-table-holder .wdt-pricing-table-icons-content .wdt-pricing-table-icons-content-list li:after' => 'border-top-width: {{SIZE}}{{UNIT}};'
							),
							'condition' => array (
								'template!' => 'list'
							),
						...
						'width' => array (
							...
							'size_units' => array ( '%' ),
							'selector' => array (
								'{{WRAPPER}} .wdt-pricing-table-holder .wdt-pricing-table-icons-content .wdt-pricing-table-icons-content-list li:after' => 'width: {{SIZE}}{{UNIT}};'
							),
							'condition' => array (
								'template!' => 'list'
							),
						...
						'gap' => array (
							...
							'size_units' => array ( 'px' ),
							'selector' => array (
								'{{WRAPPER}} .wdt-pricing-table-holder div[class*="-icons-content"] .wdt-pricing-icons-content-list li:not(:last-child):after' => 'margin-top: {{SIZE}}{{UNIT}}; padding-bottom: {{SIZE}}{{UNIT}};'
							),
							'condition' => array (
								'template!' => 'list'
							),
	...
	public function render_html($widget_object, $settings) {
		...
		$output .= '<div class="wdt-pricing-table-holder '.esc_attr(implode(' ', $classes)).'" id="wdt-pricing-table-'.esc_attr($module_id).'">';
			...
			if($settings['template'] == 'default') {
				...
				// Icons
				$output .= $this->render_icons_html($settings, $widget_object);
				...
				$output .= $this->render_features_html($settings, $widget_object);
				// Footer
				$output .= $this->render_footer_html_list($settings, $link_start, $link_end);
				...
				if(is_array($content_positions) && !empty($content_positions)) {
					...
					foreach($content_positions as $content_position) {
						if($content_position == 'media') {
							...
							$output .= $this->render_pricing_html($settings);
						} else if($content_position == 'icons') {
							$output .= $this->render_icons_html($settings, $widget_object);
	...
	public function render_icons_html($settings, $widget_object) {

		$output = '';

		if(is_array($settings['icons_content']) && !empty($settings['icons_content'])) {
			$output .= '<div class="wdt-pricing-table-icons-content">';
				$output .= '<ul class="wdt-pricing-table-icons-content-list">';
					foreach($settings['icons_content'] as $key => $icons_content) {
						$output .= '<li class="elementor-repeater-item-'.esc_attr($icons_content['_id']).'">';
							$output .= '<div class="wdt-pricing-table-icons-content-list-inner">';
								if (!empty($icons_content['media_icon_item']['value'])) {
									$output .= '<span class="wdt-pricing-table-icons-content-list-icon">';
										$output .= '<div class="wdt-content-icon-wrapper">';
										$output .= '<div class="wdt-content-icon"><span>';
											$output .= ($icons_content['media_icon_item']['library'] === 'svg') ? '<i>' : '';
												ob_start();
												\Elementor\Icons_Manager::render_icon( $icons_content['media_icon_item'], [ 'aria-hidden' => 'true' ] );
												$output .= ob_get_clean();
											$output .= ($icons_content['media_icon_item']['library'] === 'svg') ? '</i>' : '';
										$output .= '</span></div>';
									$output .= '</div>';
	...
	public function render_footer_html_list($settings, $link_start, $link_end) {
