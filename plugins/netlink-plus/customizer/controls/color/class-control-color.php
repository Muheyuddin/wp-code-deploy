...
class Netlink_Customize_Control_Color extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'netlink-plus-color-control', NETLINK_PLUS_DIR_URL.'customizer/controls/color/color.js', array( 'jquery', 'customize-base' , 'netlink-plus-customizer-color-picker' ), NETLINK_PLUS_VERSION, true );
		wp_enqueue_style( 'netlink-plus-color-control',  NETLINK_PLUS_DIR_URL.'customizer/controls/color/color.css', null, NETLINK_PLUS_VERSION );
	}
