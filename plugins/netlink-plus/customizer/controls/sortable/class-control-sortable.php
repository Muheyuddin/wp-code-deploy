...
class Netlink_Customize_Control_Sortable extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'netlink-plus-sortable-control', NETLINK_PLUS_DIR_URL.'customizer/controls/sortable/sortable.js', array( 'jquery', 'customize-base' ), NETLINK_PLUS_VERSION, true );
		wp_enqueue_style( 'netlink-plus-sortable-control',  NETLINK_PLUS_DIR_URL.'customizer/controls/sortable/sortable.css', null, NETLINK_PLUS_VERSION );
	}
