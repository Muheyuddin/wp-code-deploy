...
class Netlink_Customize_Control_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'netlink-plus-spacing-control', NETLINK_PLUS_DIR_URL.'customizer/controls/spacing/spacing.js', array( 'jquery', 'customize-base' ), NETLINK_PLUS_VERSION, true );
		wp_enqueue_style( 'netlink-plus-spacing-control',  NETLINK_PLUS_DIR_URL.'customizer/controls/spacing/spacing.css', null, NETLINK_PLUS_VERSION );
	}
