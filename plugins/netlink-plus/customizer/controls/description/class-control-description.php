...
class Netlink_Customize_Control_Description extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'netlink-plus-description-control',  NETLINK_PLUS_DIR_URL.'customizer/controls/description/description.css', null, NETLINK_PLUS_VERSION );
	}
