...
class Netlink_Customize_Control_Fontawesome extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'netlink-plus-fontawesome-control', NETLINK_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.js', array( 'jquery', 'customize-base' ), NETLINK_PLUS_VERSION, true );
		wp_enqueue_style( 'netlink-plus-fontawesome-control',  NETLINK_PLUS_DIR_URL . 'customizer/controls/fontawesome/fontawesome.css', null, NETLINK_PLUS_VERSION );

		wp_enqueue_style( 'netlink-plus-fontawesome',  NETLINK_PLUS_DIR_URL . 'customizer/assets/css/fontawesome-all.css', array(),NETLINK_PLUS_VERSION, 'all' );
	}
	...
	public function to_json() {
		...
		$this->json['reset'] = esc_html__( "Reset", "netlink-plus") .' '.esc_html( $this->label );
