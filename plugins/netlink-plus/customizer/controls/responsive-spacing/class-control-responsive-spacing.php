...
class Netlink_Customize_Control_Responsive_Spacing extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'netlink-plus-responsive-spacing-control', NETLINK_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.js', array( 'jquery', 'customize-base' ), NETLINK_PLUS_VERSION, true );
		wp_enqueue_style( 'netlink-plus-responsive-spacing-control',  NETLINK_PLUS_DIR_URL.'customizer/controls/responsive-spacing/responsive-spacing.css', null, NETLINK_PLUS_VERSION );
	}
