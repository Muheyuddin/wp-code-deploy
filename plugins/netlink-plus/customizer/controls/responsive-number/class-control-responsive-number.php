...
class Netlink_Customize_Control_Responsive_Number extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'netlink-plus-responsive-number-control', NETLINK_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.js', array( 'jquery', 'customize-base' ), NETLINK_PLUS_VERSION, true );
		wp_enqueue_style( 'netlink-plus-responsive-number-control',  NETLINK_PLUS_DIR_URL . 'customizer/controls/responsive-number/responsive-number.css', null, NETLINK_PLUS_VERSION );
	}
