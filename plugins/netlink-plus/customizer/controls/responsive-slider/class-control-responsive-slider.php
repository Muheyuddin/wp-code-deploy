...
class Netlink_Customize_Control_Responsive_Slider extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'netlink-plus-responsive-slider-control', NETLINK_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.js', array( 'jquery', 'customize-base' ), NETLINK_PLUS_VERSION, true );
		wp_enqueue_style( 'netlink-plus-responsive-slider-control',  NETLINK_PLUS_DIR_URL . 'customizer/controls/responsive-slider/responsive-slider.css', null, NETLINK_PLUS_VERSION );
	}
