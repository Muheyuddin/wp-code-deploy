...
class Netlink_Customize_Control_Radio_Image extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'netlink-plus-radio-image-control', NETLINK_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.js', array( 'jquery', 'customize-base' ), NETLINK_PLUS_VERSION, true );
		wp_enqueue_style( 'netlink-plus-radio-image-control',  NETLINK_PLUS_DIR_URL . 'customizer/controls/radio-image/radio-image.css', null, NETLINK_PLUS_VERSION );
	}
