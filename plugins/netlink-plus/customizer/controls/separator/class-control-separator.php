...
class Netlink_Customize_Control_Separator extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'netlink-plus-separator-control',  NETLINK_PLUS_DIR_URL.'customizer/controls/separator/separator.css', null, NETLINK_PLUS_VERSION );
	}
