;(function ( $, window, document, undefined ) {
    'use strict';
    $.NETLINKPLUSWPCUSTOMIZER = $.NETLINKPLUSWPCUSTOMIZER || {};

	$.NETLINKPLUSWPCUSTOMIZER.DEPENDENCY = function( el, param ) {
	...
	$.fn.NETLINKPLUSWPCUSTOMIZER_DEPENDENCY = function ( param ) {
		return this.each(function () {
			new $.NETLINKPLUSWPCUSTOMIZER.DEPENDENCY( this, param );
		});
	};

	$(document).ready( function() {
		$('.wp-customizer').NETLINKPLUSWPCUSTOMIZER_DEPENDENCY();
	});
