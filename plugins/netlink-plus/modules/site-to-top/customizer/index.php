...
if( !class_exists( 'NetlinkPlusCustomizerSiteToTop' ) ) {
    class NetlinkPlusCustomizerSiteToTop {
        ...
        function register_general( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Netlink_Customize_Section(
                    ...
                    'site-to-top-section',
                    array(
                        'title'    => esc_html__('To Top', 'netlink-plus'),
                ...
                $wp_customize->add_setting(
                    NETLINK_CUSTOMISER_VAL . '[show_site_to_top]', array(
                        'type' => 'option',
                    )
                );
                ...
                $wp_customize->add_control(
                    new Netlink_Customize_Control_Switch(
                        $wp_customize, NETLINK_CUSTOMISER_VAL . '[show_site_to_top]', array(
                            'type'    => 'wdt-switch',
                            'section' => 'site-to-top-section',
                            'label'   => esc_html__( 'Enable To Top', 'netlink-plus' ),
                            'choices' => array(
...
NetlinkPlusCustomizerSiteToTop::instance();