...
if( !class_exists( 'NetlinkPlusBreadCrumbTypo' ) ) {
    class NetlinkPlusBreadCrumbTypo {
        ...
        function register( $wp_customize ) {
            $wp_customize->add_section(
                new Netlink_Customize_Section(
                    ...
                    array(
                        'title'    => esc_html__('Typography', 'netlink-plus'),
                ...
                if ( ! defined( 'NETLINK_PRO_VERSION' ) ) {
                    $wp_customize->add_control(
                        new Netlink_Customize_Control_Separator(
                            $wp_customize, NETLINK_CUSTOMISER_VAL . '[netlink-plus-site-breadcrumb-typo-separator]',
                            array(
                                'type'        => 'wdt-separator',
...
NetlinkPlusBreadCrumbTypo::instance();