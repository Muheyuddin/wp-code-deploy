...
if( !class_exists( 'NetlinkPlusLogoWidget' ) ) {
    class NetlinkPlusLogoWidget {
        ...
        function register_widgets( $widgets_manager ) {
            require NETLINK_PLUS_DIR_PATH. 'modules/menu/elementor/widgets/logo/class-widget-logo.php';
            $widgets_manager->register( new \Elementor_logo() );
        }

        function register_widget_styles() {
            wp_register_style( 'wdt-logo',
                NETLINK_PLUS_DIR_URL . 'modules/menu/elementor/widgets/assets/css/logo.css', array(), NETLINK_PLUS_VERSION );
        }
...
NetlinkPlusLogoWidget::instance();