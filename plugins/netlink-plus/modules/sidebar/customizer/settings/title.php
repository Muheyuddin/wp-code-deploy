...
if( !class_exists( 'NetlinkPlusWidgetTitleSettings' ) ) {
    class NetlinkPlusWidgetTitleSettings {
        ...
        function register( $wp_customize ){
            ...
            $wp_customize->add_section(
                new Netlink_Customize_Section(
                    ...
                    array(
                        'title'    => esc_html__('Widget Title', 'netlink-plus'),
            ...
            if ( ! defined( 'NETLINK_PRO_VERSION' ) ) {
                $wp_customize->add_control(
                    new Netlink_Customize_Control_Separator(
                        $wp_customize, NETLINK_CUSTOMISER_VAL . '[netlink-plus-site-sidebar-title-separator]',
                        array(
                            'type'        => 'wdt-separator',
...
NetlinkPlusWidgetTitleSettings::instance();