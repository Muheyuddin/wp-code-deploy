...
if( !class_exists( 'NetlinkPlusSidebar' ) ) {
    class NetlinkPlusSidebar {
        ...
        function load_modules() {
            include_once NETLINK_PLUS_DIR_PATH.'modules/sidebar/customizer/index.php';
        }

        function frontend() {
            add_filter('netlink_primary_classes', array( $this, 'primary_classes' ), 10 );
            add_filter('netlink_secondary_classes', array( $this, 'secondary_classes' ), 10 );
        }
