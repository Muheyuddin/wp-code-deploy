...
if( !class_exists( 'NetlinkPlusSiteCustomLoader' ) ) {
    class NetlinkPlusSiteCustomLoader {
        ...
        function add_option( $options ) {
            $options['custom-loader'] = esc_html__('Custom Loader', 'netlink-plus');
            return $options;
        }

        function enqueue_assets() {
            wp_enqueue_style( 'site-loader', NETLINK_PLUS_DIR_URL . 'modules/site-loader/layouts/custom-loader/assets/css/custom-loader.css', false, NETLINK_PLUS_VERSION, 'all' );
        }
...
NetlinkPlusSiteCustomLoader::instance();