...
if( !class_exists( 'BlogPaginationInfiniteScroll' ) ) {
    class BlogPaginationInfiniteScroll {
        ...
        function enqueue_js_assets() {
        	wp_enqueue_script( 'post-infinite', NETLINK_PLUS_DIR_URL . 'modules/blog/assets/js/post-infinite.js', array(), NETLINK_PLUS_VERSION, true );
			wp_localize_script('post-infinite', 'netlink_urls', array(
