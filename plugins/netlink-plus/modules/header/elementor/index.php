...
if( !class_exists( 'NetlinkPlusHeaderElementor' ) ) {
    class NetlinkPlusHeaderElementor {
        ...
        function frontend() {
            add_filter( 'netlink_print_header_template', array( $this, 'register_header_template' ), 10, 1 );
        }
		...
		function register_header_template( $id ) {
            ...
            return apply_filters( 'netlink_plus_header_content', $content );
		}
    }
}

NetlinkPlusHeaderElementor::instance();