...
if( !class_exists( 'NetlinkPlusCustomizerSiteTitle' ) ) {
    class NetlinkPlusCustomizerSiteTitle {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_section(
                new Netlink_Customize_Section(
                    ...
                    'site-title-section',
                    array(
                        'title'    => esc_html__('Site Title', 'netlink-plus'),
            ...
            if ( ! defined( 'NETLINK_PRO_VERSION' ) ) {
                $wp_customize->add_control(
                    new Netlink_Customize_Control_Separator(
                        $wp_customize, NETLINK_CUSTOMISER_VAL . '[netlink-plus-site-title-separator]',
                        array(
                            'type'        => 'wdt-separator',
...
NetlinkPlusCustomizerSiteTitle::instance();