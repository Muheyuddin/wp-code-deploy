...
if(!function_exists('dtdr_on_order_status_completion_from_listings_module')) {
	function dtdr_on_order_status_completion_from_listings_module($order_id) {
		...
		foreach ( $items as $item_id => $item ) {
			...
			// For Listing
			if(in_array($post_type, array('dtdr_listings'))) {

				$listing_id = $dtdr_item_id;
	...
	add_action('woocommerce_order_status_completed','dtdr_on_order_status_completion_from_listings_module');
}

if(!function_exists('dtdr_on_order_status_cancellation_from_listings_module')) {
	function dtdr_on_order_status_cancellation_from_listings_module($order_id) {
	...
	add_action('woocommerce_order_status_cancelled','dtdr_on_order_status_cancellation_from_listings_module');
	add_action('woocommerce_order_status_refunded','dtdr_on_order_status_cancellation_from_listings_module');
}

// While deleting user
if(!function_exists('dtdr_on_user_deletion_from_listings_module')) {
    ...
    add_action('delete_user', 'dtdr_on_user_deletion_from_listings_module');
}
