	...
	$output .= '<form name="formOptionSettings" class="formOptionSettings" method="post">';
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.esc_html__( 'Comment Requires Active Package', 'dtdr') .'</label>';
			$output .= '</div>';
		...
		$output .= '<a href="#" class="custom-button-style dtdr-save-options-settings" data-settings="comments">'.esc_html__('Save Settings', 'dtdr').'</a>';
