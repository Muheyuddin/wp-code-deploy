...
class DTDirectorySpMediaAttachments extends Widget_Base {
	...
	public function get_name() {
		return 'dtdr-widget-sp-media-attachments';
	}

	public function get_title() {
		return esc_html__( 'Media - Attachments', 'dtdr' );
	}

	public function get_style_depends() {
		return array ('dtdr-media-attachments-frontend');
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtdr_sp_media_attachments '.$attributes.' /]');
