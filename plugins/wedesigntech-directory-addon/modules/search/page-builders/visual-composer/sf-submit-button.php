...
function dtdr_sf_submit_button_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( 'Submit Button', 'dtdr' ),
		...
		"params" => array(
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Output Type','dtdr'),
				'param_name' => 'output_type',
				'value' => array(
					esc_html__('Same Page - Ajax Load', 'dtdr') => '',
					esc_html__('Separate Page', 'dtdr') => 'separate-page',
				),
			...
			array(
				'type' => 'textfield',
				'heading' => esc_html__( 'Separate Page URL', 'dtdr' ),
