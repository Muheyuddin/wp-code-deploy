...
function dtdr_sf_orderby_field_vc_map() {
	...
	vc_map( array(
		...
		"params" => array(
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Alphabetical Order', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Highest Rated Order', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Most Reviewed Order', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Most Viewed Order', 'dtdr'),
