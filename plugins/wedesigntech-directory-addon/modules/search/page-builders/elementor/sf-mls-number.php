...
class DTDirectorySfMlsNumber extends Widget_Base {
	...
	public function get_name() {
		return 'dtdr-widget-sf-mls-number';
	}

	public function get_title() {
		return esc_html__( 'MLS Number', 'dtdr' );
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtdr_sf_mls_number_field '.$attributes.' /]');
