...
class DTDirectorySfIncharges extends Widget_Base {
	...
	public function get_name() {
		return 'dtdr-widget-sf-incharges';
	}

	public function get_title() {
        $incharge_plural_label = apply_filters( 'incharge_label', 'plural' );
		return sprintf( esc_html__('%1$s', 'dtdr'), $incharge_plural_label );
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtdr_sf_incharges_field '.$attributes.' /]');
