<?php 
add_action( 'vc_before_init', 'dtdr_sf_sellers_field_vc_map' );

function dtdr_sf_sellers_field_vc_map() {

	$listing_singular_label = apply_filters( 'listing_label', 'singular' );
	$seller_plural_label = apply_filters( 'seller_label', 'plural' );

	vc_map( array(
		"name" => $seller_plural_label,
		"base" => "dtdr_sf_sellers_field",
		"icon" => "dtdr_sf_sellers_field",
