<?php
add_action( 'vc_before_init', 'dtdr_sp_event_dates_vc_map' );

function dtdr_sp_event_dates_vc_map() {

	$listing_singular_label = apply_filters( 'listing_label', 'singular' );

	vc_map( array(
		"name" => esc_html__( 'Event Dates', 'dtdr' ),
		"base" => "dtdr_sp_event_dates",
		"icon" => "dtdr_sp_event_dates",
		...
		"params" => array(
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Include Start Date', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Include End Date', 'dtdr'),
				'description' => esc_html__('Choose "True" if you like to display end date in this shortcode. If "Merge Date" option is chosen "End Date" will be included automatically.', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Include Start Time', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Include End Time', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Include Post Date', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Include Post Time', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('With Label', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('With Icon', 'dtdr'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Merge Dates', 'dtdr'),
