	...
	$output .= '<form name="formOptionSettings" class="formOptionSettings" method="post">';	
		...
		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Singular Label', 'dtdr' ), $listing_singular_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            ...
	            $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Listing" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Plural Label', 'dtdr' ), $listing_plural_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="listing-plural-label" name="dtdr[label][listing-plural-label]" type="text" value="'.$listing_plural_label.'" />';
	            $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Listings" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Singular Label', 'dtdr' ), $contracttype_singular_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            ...
	            $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Contract Type" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Plural Label', 'dtdr' ), $contracttype_plural_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            ...
	            $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Contract Types" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Singular Label', 'dtdr' ), $amenity_singular_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="amenity-singular-label" name="dtdr[label][amenity-singular-label]" type="text" value="'.$amenity_singular_label.'" />';
	            $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Amenity" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Plural Label', 'dtdr' ), $amenity_plural_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="amenity-plural-label" name="dtdr[label][amenity-plural-label]" type="text" value="'.$amenity_plural_label.'" />';
	            $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Amenities" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Singular Label', 'dtdr' ), $seller_singular_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="seller-singular-label" name="dtdr[label][seller-singular-label]" type="text" value="'.$seller_singular_label.'" />';
	            $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Seller" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Plural Label', 'dtdr' ), $seller_plural_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="seller-plural-label" name="dtdr[label][seller-plural-label]" type="text" value="'.$seller_plural_label.'" />';
	         $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Sellers" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Singular Label', 'dtdr' ), $incharge_singular_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="incharge-singular-label" name="dtdr[label][incharge-singular-label]" type="text" value="'.$incharge_singular_label.'" />';
	            $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Incharge" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-settings-options-holder">';
			$output .= '<div class="dtdr-column dtdr-one-fifth first">';
				$output .= '<label>'.sprintf( esc_html__( '%1$s Plural Label', 'dtdr' ), $incharge_plural_label ).'</label>';
			$output .= '</div>';
			$output .= '<div class="dtdr-column dtdr-four-fifth">';
	            $output .= '<input id="incharge-plural-label" name="dtdr[label][incharge-plural-label]" type="text" value="'.$incharge_plural_label.'" />';
	         $output .= '<div class="dtdr-note">'.esc_html__('You can replace the "Incharges" label as per your requirement.', 'dtdr').'</div>';
			$output .= '</div>';
		$output .= '</div>';

		$output .= '<div class="dtdr-option-settings-response-holder"></div>';

		$output .= '<a href="#" class="custom-button-style dtdr-save-options-settings" data-settings="label">'.esc_html__('Save Settings', 'dtdr').'</a>';
