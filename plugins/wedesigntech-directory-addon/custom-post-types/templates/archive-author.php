		...
		?>
			...
			if(in_array('seller', $user_roles)) {
				...
				echo '<div class="dtdr-author-listings-container">';
					...
					echo '<h4>'.sprintf( esc_html__('%1$s %2$s', 'dtdr'), $seller_singular_label, $listing_plural_label ).'</h4>';
				...
				echo '<div class="dtdr-author-listings-container">';
					...
					echo '<h4>'.sprintf( esc_html__('%1$s %2$s', 'dtdr'), $incharge_singular_label, $listing_plural_label ).'</h4>';
