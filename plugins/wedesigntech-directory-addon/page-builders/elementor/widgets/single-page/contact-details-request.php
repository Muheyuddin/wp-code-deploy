...
class DTDirectorySpContactDetailsRequest extends Widget_Base {
	...
	public function get_name() {
		return 'dtdr-widget-sp-contact-details-request';
	}

	public function get_title() {
		return esc_html__( 'Contact Details - Send Request Button', 'dtdr' );
	}

	public function get_style_depends() {
		return array ( 'dtdr-modules-singlepage', 'dtdr-modules-default' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'features_default_section', array(
			...
			$this->add_control( 'button_label', array(
				'label'   => esc_html__( 'Button Label', 'dtdr' ),
				'type'    => Controls_Manager::TEXT,
				'description' => esc_html__( 'If you wish you can change the button label here.', 'dtdr' ),
				'default' => ''
			) );
	...
	protected function render() {
		...
		echo do_shortcode('[dtdr_sp_contact_details_request_btn '.$attributes.' /]');
