...
class DTDirectorySpFeaturedItem extends Widget_Base {
	...
	public function get_name() {
		return 'dtdr-widget-sp-featured-item';
	}

	public function get_title() {
		return esc_html__( 'Featured Item', 'dtdr' );
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtdr_sp_featured_item '.$attributes.' /]');
