...
class DTDirectorySpCommentForm extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Comment Form', 'dtdr' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section( 'comment_form_default_section', array(
			...
			$this->add_control( 'form_title', array(
				'label'       => esc_html__( 'Form Title', 'dtdr' ),
			...
			$this->add_control( 'form_comment_field_placeholder', array(
				'label'   => esc_html__( 'Form Comment Field Placeholder', 'dtdr' ),
				'type'    => Controls_Manager::TEXT,
			...
			$this->add_control( 'form_submit_button_label', array(
				'label'   => esc_html__( 'Form Submit Button Label', 'dtdr' ),
				'type'    => Controls_Manager::TEXT,
