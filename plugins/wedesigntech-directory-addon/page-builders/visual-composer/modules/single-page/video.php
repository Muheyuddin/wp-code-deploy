...
function dtdr_sp_video_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( 'Media - Video', 'dtdr' ),
		"base" => "dtdr_sp_video",
		"icon" => "dtdr_sp_video",
		...
		"params" => array(
			...
			array(
				...
				'description' => sprintf( esc_html__('Provide %1$s id for which you have to display video. No need to provide ID if it is used in %1$s single page.', 'dtdr'), strtolower($listing_singular_label) ),
