<?php
add_action( 'vc_before_init', 'dtdr_sp_post_dates_vc_map' );

function dtdr_sp_post_dates_vc_map() {

	$listing_singular_label = apply_filters( 'listing_label', 'singular' );

	vc_map( array(
		"name" => esc_html__( 'Dates', 'dtdr' ),
		"base" => "dtdr_sp_post_dates",
		"icon" => "dtdr_sp_post_dates",
