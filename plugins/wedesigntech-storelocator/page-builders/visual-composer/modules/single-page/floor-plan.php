<?php
add_action( 'vc_before_init', 'dtsl_sp_floor_plan_vc_map' );

function dtsl_sp_floor_plan_vc_map() {

	$dt_sl_listing_singular_label = apply_filters( 'dt_sl_listing_label', 'singular' );

	vc_map( array(
		"name" => esc_html__( 'Floor Plan', 'dtsl' ),
		"base" => "dtsl_sp_floor_plan",
		"icon" => "dtsl_sp_floor_plan",
		...
		"params" => array(
			...
			array(
				...
				'description' => sprintf( esc_html__('Provide %1$s id for which you have to display floor plan. No need to provide ID if it is used in %1$s single page.', 'dtsl'), strtolower($dt_sl_listing_singular_label) ),
