<?php
add_action( 'vc_before_init', 'dtsl_sp_post_dates_vc_map' );

function dtsl_sp_post_dates_vc_map() {

	$dt_sl_listing_singular_label = apply_filters( 'dt_sl_listing_label', 'singular' );

	vc_map( array(
		"name" => esc_html__( 'Dates', 'dtsl' ),
		"base" => "dtsl_sp_post_dates",
		"icon" => "dtsl_sp_post_dates",
