<?php
add_action( 'vc_before_init', 'dtsl_sp_taxonomy_vc_map' );

function dtsl_sp_taxonomy_vc_map() {
	...
	vc_map( array(
		"name" => esc_html__( 'Taxonomy', 'dtsl' ),
		"base" => "dtsl_sp_taxonomy",
		"icon" => "dtsl_sp_taxonomy",
		...
		"params" => array(
			...
			array(
				...
				'description' => sprintf( esc_html__('Provide %1$s id for which you have to display categories. No need to provide ID if it is used in %1$s single page.', 'dtsl'), strtolower($dt_sl_listing_singular_label) ),
