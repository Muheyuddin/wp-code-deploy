...
class DTStoreLocatorSpPostDate extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sp-post-date';
	}

	public function get_title() {
		return esc_html__( 'Post Date', 'dtsl' );
	}

	public function get_style_depends() {
		$file_handlers =  dtsl_dependent_files_instance()->dtsl_single_page_module_files( 'dtsl_sp_post_date' );
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sp_post_date '.$attributes.' /]');
