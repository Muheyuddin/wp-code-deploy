...
class DTStoreLocatorSpFeaturedItem extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sp-featured-item';
	}

	public function get_title() {
		return esc_html__( 'Featured Item', 'dtsl' );
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sp_featured_item '.$attributes.' /]');
