...
class DTStoreLocatorSpTaxonomy extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sp-taxonomy';
	}

	public function get_title() {
		return esc_html__( 'Taxonomy', 'dtsl' );
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sp_taxonomy '.$attributes.' /]');
