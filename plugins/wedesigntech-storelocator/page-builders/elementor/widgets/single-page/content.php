...
class DTStoreLocatorSpContent extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sp-content';
	}

	public function get_title() {
		return esc_html__( 'Content', 'dtsl' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section( 'content_default_section', array(
			...
			$this->add_control( 'type', array(
				...
				'options'     => array(
					'excerpt' => esc_html__( 'Excerpt', 'dtsl' ),
					'content' => esc_html__( 'Content', 'dtsl' )
				),
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sp_content '.$attributes.' /]');
