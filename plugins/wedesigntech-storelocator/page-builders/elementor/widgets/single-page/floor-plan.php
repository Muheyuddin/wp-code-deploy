...
class DTStoreLocatorSpFloorPlan extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sp-floor-plan';
	}

	public function get_title() {
		return esc_html__( 'Floor Plan', 'dtsl' );
	}

	public function get_style_depends() {
		$file_handlers =  dtsl_dependent_files_instance()->dtsl_single_page_module_files( 'dtsl_sp_floor_plan' );
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sp_floor_plan '.$attributes.' /]');
