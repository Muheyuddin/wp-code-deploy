...
class DTStoreLocatorSfMlsNumber extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sf-mls-number';
	}

	public function get_title() {
		return esc_html__( 'MLS Number', 'dtsl' );
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sf_mls_number_field '.$attributes.' /]');
