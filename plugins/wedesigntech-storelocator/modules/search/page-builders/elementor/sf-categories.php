...
class DTStoreLocatorSfCategories extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sf-categories';
	}

	public function get_title() {
		return esc_html__( 'Categories', 'dtsl' );
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sf_categories_field '.$attributes.' /]');
