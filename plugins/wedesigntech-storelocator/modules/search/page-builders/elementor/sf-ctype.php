...
class DTStoreLocatorSfCType extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sf-ctype';
	}

	public function get_title() {
        $contracttype_plural_label = apply_filters( 'dt_sl_contracttype_label', 'plural' );
		return sprintf( esc_html__('%1$s', 'dtsl'), $contracttype_plural_label );
	}

	public function get_style_depends() {
		return array ( 'chosen', 'dtsl-fields', 'dtsl-search-frontend');
	}

	public function get_script_depends() {
		return array ( 'chosen', 'dtsl-search-frontend');
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sf_ctype_field '.$attributes.' /]');
