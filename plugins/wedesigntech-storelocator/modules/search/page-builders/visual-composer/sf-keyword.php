<?php
add_action( 'vc_before_init', 'dtsl_sf_keyword_field_vc_map' );

function dtsl_sf_keyword_field_vc_map() {

	vc_map( array(
		"name" => esc_html__( 'Keyword', 'dtsl' ),
		"base" => "dtsl_sf_keyword_field",
		"icon" => "dtsl_sf_keyword_field",
