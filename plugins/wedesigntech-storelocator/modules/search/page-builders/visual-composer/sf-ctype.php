<?php
add_action( 'vc_before_init', 'dtsl_sf_ctype_field_vc_map' );

function dtsl_sf_ctype_field_vc_map() {

	$contracttype_plural_label = apply_filters( 'dt_sl_contracttype_label', 'plural' );

	vc_map( array(
		"name" => sprintf( esc_html__('%1$s', 'dtsl'), $contracttype_plural_label ),
		"base" => "dtsl_sf_ctype_field",
		"icon" => "dtsl_sf_ctype_field",
