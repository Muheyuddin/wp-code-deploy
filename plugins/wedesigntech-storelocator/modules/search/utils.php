...
if(!function_exists('dtsl_search_listings_content')) {
	function dtsl_search_listings_content() {

		$output = '';

		$output .= '<div class="dtsl-search-container dtsl-search-listings-container">';
			...
			$output .= '<select class="dtsl-search-listings-seller dtsl-chosen-select" name="dtsl-search-listings-seller" data-placeholder="'.sprintf( esc_html__('Choose %1$s ...', 'dtsl'), $seller_singular_label ).'" class="dtsl-chosen-select">';
			...
			$output .= '<div class="dtsl-search-listings-data-container"></div>';
...
if(!function_exists('dtsl_search_sellerwise_listings')) {
	function dtsl_search_sellerwise_listings() {
		...
		$output .= '<div class="dtsl-column dtsl-one-half first">';
			...
			$output .= '<div class="dtsl-search-listings-count">'.sprintf( esc_html__( 'Total %1$s', 'dtsl' ), $listing_plural_label ).'<span>'.$listings_query->found_posts.'</span></div>';
			...
			$output .= dtsl_ajax_pagination($max_num_pages, $current_page, 'dtsl_search_sellerwise_listings', 'dtsl-search-listings-data-container', $item_ids);
			// Pagination script End

		$output .= '</div>';
		$output .= '<div class="dtsl-column dtsl-one-half">';

			$output .= '<div class="dtsl-search-listings-inner-data-container"></div>';
	...
	add_action( 'wp_ajax_dtsl_search_sellerwise_listings', 'dtsl_search_sellerwise_listings' );
	add_action( 'wp_ajax_nopriv_dtsl_search_sellerwise_listings', 'dtsl_search_sellerwise_listings' );
}

// Search Sellers - Default Content
if(!function_exists('dtsl_search_sellers_content')) {
	function dtsl_search_sellers_content() {

		$output = '';

		$output .= '<div class="dtsl-search-container dtsl-search-sellers-container">';

			$output .= dtsl_generate_loader_html(true);

			$output .= '<div class="dtsl-search-sellers-data-container"></div>';
...
if(!function_exists('dtsl_search_sellers')) {
	function dtsl_search_sellers() {
		...
		$output .= '<div class="dtsl-column dtsl-two-third first">';
										...
										$output .= '<tr>
														...
														<td>';
															...
															if($seller_incharges > 0) {
																$output .= '<a href="#" class="custom-button-style dtsl-search-seller-incharges" data-sellerid="'.esc_html($seller_id).'">'.esc_html__('View Details', 'dtsl').'</a>';
															}
														...
														$output .= '</td><td>';
															...
															$output .= $post_cnt;
															if($post_cnt > 0) {
																$output .='<a href="#" class="custom-button-style dtsl-search-seller-listings" data-sellerid="'.esc_html($seller_id).'">'.esc_html__('View Details', 'dtsl').'</a>';
															}
			...
			$output .= dtsl_ajax_pagination($max_num_pages, $current_page, 'dtsl_search_sellers', 'dtsl-search-sellers-data-container', $item_ids);
			// Pagination script End

		$output .= '</div>';
		$output .= '<div class="dtsl-column dtsl-one-third">';

			$output .= '<div class="dtsl-search-sellers-inner-data-container"></div>';
	...
	add_action( 'wp_ajax_dtsl_search_sellers', 'dtsl_search_sellers' );
	add_action( 'wp_ajax_nopriv_dtsl_search_sellers', 'dtsl_search_sellers' );
}

// Search Sellers - Incharges
if(!function_exists('dtsl_search_seller_incharges')) {
	function dtsl_search_seller_incharges() {
	...
	add_action( 'wp_ajax_dtsl_search_seller_incharges', 'dtsl_search_seller_incharges' );
	add_action( 'wp_ajax_nopriv_dtsl_search_seller_incharges', 'dtsl_search_seller_incharges' );
}

// Search Sellers - Listings
if(!function_exists('dtsl_search_seller_listings')) {
	function dtsl_search_seller_listings() {
	...
	add_action( 'wp_ajax_dtsl_search_seller_listings', 'dtsl_search_seller_listings' );
	add_action( 'wp_ajax_nopriv_dtsl_search_seller_listings', 'dtsl_search_seller_listings' );
}

// Search Packages - Default Content
if(!function_exists('dtsl_search_packages_content')) {
	function dtsl_search_packages_content() {

		$output = '';

		$output .= '<div class="dtsl-search-container dtsl-search-packages-container">';

			$output .= dtsl_generate_loader_html(true);

			$output .= '<div class="dtsl-search-packages-data-container"></div>';
...
if(!function_exists('dtsl_search_packages')) {
	function dtsl_search_packages() {
		...
		$output .= '<div class="dtsl-custom-table-wrapper">';
										...
										$output .= '<tr>
														...
														<td>';
															...
															if(count($purchased_users) > 0) {
																$output .='<a href="#" class="custom-button-style dtsl-search-package-purchases" data-packageid="'.esc_html($package_id).'">'.esc_html__('View Details', 'dtsl').'</a>';
															}
			...
			$output .= '<div class="dtsl-search-packages-count">'.esc_html__( 'Total Packages', 'dtsl' ).'<span>'.$packages_query->found_posts.'</span></div>';
			...
			$output .= dtsl_ajax_pagination($max_num_pages, $current_page, 'dtsl_search_packages', 'dtsl-search-packages-data-container', $item_ids);
			// Pagination script End

		$output .= '</div>';

		$output .= '<div class="dtsl-search-packages-inner-data-container"></div>';
	...
	add_action( 'wp_ajax_dtsl_search_packages', 'dtsl_search_packages' );
	add_action( 'wp_ajax_nopriv_dtsl_search_packages', 'dtsl_search_packages' );
}

// Search Packages - Purchased Users
if(!function_exists('dtsl_search_packages_purchases_user_details')) {
	function dtsl_search_packages_purchases_user_details() {
	...
	add_action( 'wp_ajax_dtsl_search_packages_purchases_user_details', 'dtsl_search_packages_purchases_user_details' );
	add_action( 'wp_ajax_nopriv_dtsl_search_packages_purchases_user_details', 'dtsl_search_packages_purchases_user_details' );
}
