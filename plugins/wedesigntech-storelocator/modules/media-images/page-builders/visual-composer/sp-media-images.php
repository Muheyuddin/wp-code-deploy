<?php
add_action( 'vc_before_init', 'dtsl_sp_media_images_vc_map' );

function dtsl_sp_media_images_vc_map() {

	$dt_sl_listing_singular_label = apply_filters( 'dt_sl_listing_label', 'singular' );

	vc_map( array(
		"name" => esc_html__( 'Media - Images', 'dtsl' ),
		"base" => "dtsl_sp_media_images",
		"icon" => "dtsl_sp_media_images",
		...
		"params" => array(
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Show Image Description', 'dtsl'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Include Feature Image', 'dtsl'),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Enable Vertical Direction', 'dtsl'),
			...
			array(
				...
				'value' => array(
					...
					esc_html__('Scroll Bar', 'dtsl')   => 'scrollbar',
					esc_html__('Thumbnail', 'dtsl')    => 'thumbnail'
				),
			...
			array(
				'type' => 'dropdown',
				'heading' => esc_html__('Number of Thumbnails', 'dtsl'),
