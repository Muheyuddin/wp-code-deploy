...
class DTStoreLocatorSpEventDates extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sp-event-dates';
	}

	public function get_title() {
		return esc_html__( 'Event Dates', 'dtsl' );
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sp_event_dates '.$attributes.' /]');
