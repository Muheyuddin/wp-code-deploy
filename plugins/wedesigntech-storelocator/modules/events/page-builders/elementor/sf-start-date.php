...
class DTStoreLocatorSfStartDate extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sf-start-date';
	}

	public function get_title() {
        return esc_html__( 'Start Date', 'dtsl' );
	}
	...
	public function get_script_depends() {
		return array ( 'dtsl-events-common' );
	}
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sf_startdate_field '.$attributes.' /]');
