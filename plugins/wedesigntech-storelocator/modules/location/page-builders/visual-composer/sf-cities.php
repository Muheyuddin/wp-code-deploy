<?php
add_action( 'vc_before_init', 'dtsl_sf_cities_field_vc_map' );

function dtsl_sf_cities_field_vc_map() {

	$dt_sl_listing_singular_label = apply_filters( 'dt_sl_listing_label', 'singular' );

	vc_map( array(
		"name" => esc_html__( 'Cities', 'dtsl' ),
		"base" => "dtsl_sf_cities_field",
		"icon" => "dtsl_sf_cities_field",
