<?php
add_action( 'vc_before_init', 'dtsl_sf_countystate_field_vc_map' );

function dtsl_sf_countystate_field_vc_map() {

	vc_map( array(
		"name" => esc_html__( 'Counties / States', 'dtsl' ),
		"base" => "dtsl_sf_countystate_field",
		"icon" => "dtsl_sf_countystate_field",
