...
class DTStoreLocatorSfCountyState extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sf-countystate';
	}

	public function get_title() {
		return esc_html__( 'Counties / States', 'dtsl' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section( 'countystate_default_section', array(
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sf_countystate_field '.$attributes.' /]');
