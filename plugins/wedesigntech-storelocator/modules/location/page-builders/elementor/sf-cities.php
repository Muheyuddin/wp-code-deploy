...
class DTStoreLocatorSfCities extends Widget_Base {
	...
	public function get_name() {
		return 'dtsl-widget-sf-cities';
	}

	public function get_title() {
		return esc_html__( 'Cities', 'dtsl' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section( 'cities_default_section', array(
	...
	protected function render() {
		...
		echo do_shortcode('[dtsl_sf_cities_field '.$attributes.' /]');
