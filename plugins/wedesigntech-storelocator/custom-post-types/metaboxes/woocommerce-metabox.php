...
echo '<input type="hidden" name="dtsl_woocommerce_meta_nonce" value="'.wp_create_nonce('dtsl_woocommerce_nonce').'" />';
...
<div class="custom-box">
	<div class="column one-sixth">
		<label><?php echo esc_html__('Regular price', 'dtsl'). ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
	</div>
...
<div class="custom-box">
	<div class="column one-sixth">
		<label><?php echo esc_html__('Sale price', 'dtsl'). ' (' . get_woocommerce_currency_symbol() . ')'; ?></label>
	</div>
	<div class="column five-sixth last">
