...
if( !class_exists( 'NetlinkProGlobalSibarSettings' ) ) {
    class NetlinkProGlobalSibarSettings {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_setting(
                NETLINK_CUSTOMISER_VAL . '[global_sidebar]', array(
                    'type' => 'option',
                )
            );
            ...
            $wp_customize->add_control( new Netlink_Customize_Control(
                $wp_customize, NETLINK_CUSTOMISER_VAL . '[global_sidebar]', array(
                    'type'       => 'select',
                    'section'    => 'site-global-sidebar-section',
                    'label'      => esc_html__( 'Global Custom Sidebar?', 'netlink-pro' ),
...
NetlinkProGlobalSibarSettings::instance();