...
if( !class_exists( 'Netlink_Woo_Listing_Type_Custom' ) ) {

    class Netlink_Woo_Listing_Type_Custom {
        ...
        function __construct() {
            ...
            /* Initialize Type */
                ...
                $this->type_name = esc_html__('Custom', 'netlink-pro');
        ...
        */
            function set_type_options() {
                ...
                if( strpos($this->custom_template, 'predefined-template-') !== false ) {
                    ...
                    $field_key = str_replace('predefined-template-', 'netlink-woo-product-style-template-',  $this->custom_template);
                    ...
                    $custom_options = ( isset($dtcs_product_templates['netlink-woo-product-style-templates'][$field_key]) && !empty($dtcs_product_templates['netlink-woo-product-style-templates'][$field_key]) ) ? $dtcs_product_templates['netlink-woo-product-style-templates'][$field_key] : array ();
            ...
            function for_non_archive_listing() {
                ...
                /* Assets Load */
                    ...
                    // CSS
                        ...
                        wp_register_style( 'netlink-woo-non-archive', '', array (), NETLINK_PRO_VERSION, 'all' );
...
if( !function_exists('netlink_woo_listing_type_custom') ) {
	function netlink_woo_listing_type_custom() {
		return Netlink_Woo_Listing_Type_Custom::instance();
	}
}

netlink_woo_listing_type_custom();