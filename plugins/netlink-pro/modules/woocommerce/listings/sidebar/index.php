...
if( !class_exists( 'Netlink_Pro_Woo_Sidebar' ) ) {
    class Netlink_Pro_Woo_Sidebar {
        ...
        function frontend() {
            add_filter('netlink_primary_classes', array( $this, 'primary_classes' ) );
            add_filter('netlink_secondary_classes', array( $this, 'secondary_classes' ) );
            add_filter('netlink_active_sidebars', array( $this, 'active_sidebars' ), 20 );
            add_filter('netlink_woo_loop_column_class', array( $this, 'woo_loop_column_class' ), 10, 2 );
        }

        function primary_classes( $primary_class ) {

            if( is_shop()  ) {
                $settings = get_post_meta( get_option('woocommerce_shop_page_id'), '_netlink_layout_settings', true );
...
Netlink_Pro_Woo_Sidebar::instance();