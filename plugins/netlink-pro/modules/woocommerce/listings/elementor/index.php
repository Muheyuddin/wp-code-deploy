...
class Netlink_Pro_Elementor_Listings_Widgets {
	...
	function __construct() {
		...
		add_action( 'netlink_shop_preview_scripts', array( $this, 'netlink_shop_preview_scripts') );
	...
	function netlink_shop_load_modules() {
		...
		require NETLINK_PRO_DIR_PATH . 'modules/woocommerce/listings/elementor/widgets/products/shortcodes.php';
	...
	function netlink_shop_register_widgets( $widgets_manager ) {
		...
		require NETLINK_PRO_DIR_PATH . 'modules/woocommerce/listings/elementor/widgets/products/class-widget-products.php';
		$widgets_manager->register( new Netlink_Shop_Widget_Products() );
	...
	function netlink_shop_register_widget_styles( $suffix ) {
		...
		# Swiper
			wp_register_style( 'css-swiper',
				NETLINK_PRO_DIR_URL . 'modules/woocommerce/listings/elementor/widgets/products/assets/css/swiper.min'.$suffix.'.css',
				array()
			);

		# Carousel
			wp_register_style( 'wdt-shop-products-carousel',
				NETLINK_MODULE_URI . '/woocommerce/assets/css/carousel.css',
				array()
			);

		# Products
			wp_register_style( 'wdt-shop-products',
				NETLINK_PRO_DIR_URL . 'modules/woocommerce/listings/elementor/widgets/products/assets/css/style'.$suffix.'.css',
				array()
			);
	...
	function netlink_shop_register_widget_scripts( $suffix ) {
		...
		# Swiper
			wp_register_script( 'jquery-swiper',
				NETLINK_PRO_DIR_URL . 'modules/woocommerce/listings/elementor/widgets/products/assets/js/swiper.min'.$suffix.'.js',
				array( 'jquery' ),
				false,
				true
			);
		...
		# Products
			wp_register_script( 'wdt-shop-products',
				NETLINK_PRO_DIR_URL . 'modules/woocommerce/listings/elementor/widgets/products/assets/js/script'.$suffix.'.js',
				array( 'jquery' ),
				false,
				true
			);
		...
		# Products Admin
			wp_register_script( 'wdt-shop-admin',
				NETLINK_PRO_DIR_URL . 'modules/woocommerce/listings/elementor/widgets/products/assets/js/admin'.$suffix.'.js',
				array( 'jquery' ),
				false,
				true
			);
	 ...
	 */
	function netlink_shop_preview_scripts() {
...
Netlink_Pro_Elementor_Listings_Widgets::instance();