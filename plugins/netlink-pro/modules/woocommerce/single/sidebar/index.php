...
if( !class_exists( 'Netlink_Pro_Woo_single_Sidebar' ) ) {
    class Netlink_Pro_Woo_single_Sidebar {
        ...
        function frontend() {
            ...
            add_filter('netlink_active_sidebars', array( $this, 'active_sidebars' ), 30 );
        }
        ...
        function primary_classes( $primary_class ) {
            ...
            if( is_product() ) {
                ...
                $settings = get_post_meta( $post_id, '_netlink_layout_settings', true );
...
Netlink_Pro_Woo_single_Sidebar::instance();