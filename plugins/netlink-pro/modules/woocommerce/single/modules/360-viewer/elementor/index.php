...
class Netlink_Shop_Elementor_Single_360_Viewer_Widgets {
	...
	function netlink_shop_load_modules() {
		...
		require netlink_shop_single_module_360_viewer()->module_dir_path() . 'elementor/utils.php';
	...
	function netlink_shop_register_widgets( $widgets_manager ) {
		...
		require netlink_shop_single_module_360_viewer()->module_dir_path() . 'elementor/widgets/360-image-viewer/class-product-360-image-viewer.php';
		$widgets_manager->register( new Netlink_Shop_Widget_Product_360_Image_Viewer() );
	...
	function netlink_shop_register_widget_styles( $suffix ) {
		...
		# 360 Image Viewer
			...
			wp_register_style( 'wdt-shop-product-single-images-360-viewer',
				netlink_shop_single_module_360_viewer()->module_dir_url() . 'elementor/widgets/360-image-viewer/assets/css/style'.$suffix.'.css',
				array()
			);
	...
	function netlink_shop_register_widget_scripts( $suffix ) {
		...
		# 360 Image Viewer
			...
			wp_register_script( 'jquery-360viewer',
				netlink_shop_single_module_360_viewer()->module_dir_url() . 'elementor/widgets/360-image-viewer/assets/js/360-viewer'.$suffix.'.js',
				array( 'jquery' ),
				false,
				true
			);
			...
			wp_register_script( 'wdt-shop-product-single-images-360-viewer',
				netlink_shop_single_module_360_viewer()->module_dir_url() . 'elementor/widgets/360-image-viewer/assets/js/script'.$suffix.'.js',
				array( 'jquery' ),
				false,
				true
			);
...
Netlink_Shop_Elementor_Single_360_Viewer_Widgets::instance();