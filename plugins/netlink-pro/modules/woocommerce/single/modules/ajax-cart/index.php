...
if( !class_exists( 'Netlink_Shop_Single_Module_Ajax_Cart' ) ) {

    class Netlink_Shop_Single_Module_Ajax_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/single/modules/ajax-cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/single/modules/ajax-cart/';
                } else {
...
if( !function_exists('netlink_shop_single_module_ajax_cart') ) {
	function netlink_shop_single_module_ajax_cart() {
		return Netlink_Shop_Single_Module_Ajax_Cart::instance();
	}
}

netlink_shop_single_module_ajax_cart();