...
class Netlink_Shop_Elementor_Single_Additional_Tabs_Widgets {
	...
	function netlink_shop_load_modules() {
		...
		require netlink_shop_single_module_additional_tabs()->module_dir_path() . 'elementor/utils.php';
	...
	function netlink_shop_register_widgets( $widgets_manager ) {
		...
		require netlink_shop_single_module_additional_tabs()->module_dir_path() . 'elementor/widgets/product-tabs-exploded/class-product-tabs-exploded.php';
		$widgets_manager->register( new Netlink_Shop_Widget_Product_Additional_Tabs_Exploded() );
	...
	function netlink_shop_register_widget_styles( $suffix ) {
		...
		# Product Tabs Exploded
			...
			wp_register_style( 'wdt-shop-product-single-additional-tabs-exploded',
				netlink_shop_single_module_additional_tabs()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
				array()
			);
	...
	function netlink_shop_register_widget_scripts( $suffix ) {
		...
		# Product Tabs - Exploded
			...
			wp_register_script( 'jquery-nicescroll',
				netlink_shop_single_module_additional_tabs()->module_dir_url() . 'assets/js/jquery.nicescroll'.$suffix.'.js',
				array( 'jquery' ),
				false,
				true
			);
			...
			wp_register_script( 'wdt-shop-product-single-additional-tabs-exploded',
				netlink_shop_single_module_additional_tabs()->module_dir_url() . 'assets/js/scripts'.$suffix.'.js',
				array( 'jquery' ),
				false,
				true
			);
...
Netlink_Shop_Elementor_Single_Additional_Tabs_Widgets::instance();