...
if( !class_exists( 'Netlink_Shop_Single_Module_Additional_Tabs' ) ) {

    class Netlink_Shop_Single_Module_Additional_Tabs {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/single/modules/additional-tabs/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/single/modules/additional-tabs/';
                } else {
...
if( !function_exists('netlink_shop_single_module_additional_tabs') ) {
	function netlink_shop_single_module_additional_tabs() {
        $reflection = new ReflectionClass('Netlink_Shop_Single_Module_Additional_Tabs');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Netlink_Shop_Single_Module_Additional_Tabs::instance();