...
if( !class_exists( 'Netlink_Shop_Single_Module_Additional_Info' ) ) {

    class Netlink_Shop_Single_Module_Additional_Info {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/single/modules/additional-info/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/single/modules/additional-info/';
                } else {
...
if( !function_exists('netlink_shop_single_module_additional_info') ) {
	function netlink_shop_single_module_additional_info() {
        $reflection = new ReflectionClass('Netlink_Shop_Single_Module_Additional_Info');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Netlink_Shop_Single_Module_Custom_template' ) ) {
    Netlink_Shop_Single_Module_Additional_Info::instance();
}