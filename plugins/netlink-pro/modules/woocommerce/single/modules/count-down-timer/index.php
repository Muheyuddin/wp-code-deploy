...
if( !class_exists( 'Netlink_Shop_Single_Module_Count_Down_Timer' ) ) {

    class Netlink_Shop_Single_Module_Count_Down_Timer {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/single/modules/count-down-timer/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/single/modules/count-down-timer/';
                } else {
...
if( !function_exists('netlink_shop_single_module_count_down_timer') ) {
	function netlink_shop_single_module_count_down_timer() {
        $reflection = new ReflectionClass('Netlink_Shop_Single_Module_Count_Down_Timer');
        return $reflection->newInstanceWithoutConstructor();
	}
}

if( class_exists( 'Netlink_Shop_Single_Module_Custom_template' ) ) {
    Netlink_Shop_Single_Module_Count_Down_Timer::instance();
}