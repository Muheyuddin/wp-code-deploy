...
if(!function_exists('netlink_shop_product_tabs_exploded_html')) {
	function netlink_shop_product_tabs_exploded_html($attrs, $content = null) {
		...
		$attrs = shortcode_atts ( array (
			...
			'scroll_height' => '',
			'class'         => ''
		), $attrs, 'netlink_shop_product_tabs_exploded' );

		$out = netlink_shop_product_tabs_exploded_render_html($attrs);

		return $out;

	}
	add_shortcode( 'netlink_shop_product_tabs_exploded', 'netlink_shop_product_tabs_exploded_html' );
}


if(!function_exists('netlink_shop_product_tabs_exploded_render_html')) {
	function netlink_shop_product_tabs_exploded_render_html($settings) {
