...
if( !class_exists( 'Netlink_Pro_Customizer_Single' ) ) {

    class Netlink_Pro_Customizer_Single {
        ...
        function register( $wp_customize ) {
            ...
            $wp_customize->add_panel(
                new Netlink_Customize_Panel(
                    ...
                    array(
                        'title'    => esc_html__('Product Single Page', 'netlink-pro'),
                ...
                $wp_customize->add_section(
                    new Netlink_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Default Settings', 'netlink-pro'),
                ...
                $wp_customize->add_section(
                    new Netlink_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Upsell Settings', 'netlink-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 20,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Netlink_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Related Settings', 'netlink-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 30,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Netlink_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Share Settings', 'netlink-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 40,
                        )
                    )
                ...
                $wp_customize->add_section(
                    new Netlink_Customize_Section(
                        ...
                        array(
                            'title'    => esc_html__('Sociable Follow Settings', 'netlink-pro'),
                            'panel'    => 'woocommerce-single-page-section',
                            'priority' => 50,
                        )
                    )
...
if( !function_exists('netlink_customizer_single') ) {
	function netlink_customizer_single() {
		return Netlink_Pro_Customizer_Single::instance();
	}
}

netlink_customizer_single();