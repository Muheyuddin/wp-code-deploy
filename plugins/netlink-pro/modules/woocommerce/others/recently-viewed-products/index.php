...
if( !class_exists( 'Netlink_Shop_Others_Recently_Viewed_Products' ) ) {

    class Netlink_Shop_Others_Recently_Viewed_Products {
        ...
        function __construct() {
            ...
            // Js Variables
                add_filter( 'netlink_woo_objects', array ( $this, 'woo_objects' ), 10, 1 );

            // Enqueue CSS
                add_action( 'netlink_before_woo_css', array ( $this, 'before_woo_css' ), 10 );

            // Enqueue JS
                add_action( 'netlink_before_woo_js', array ( $this, 'before_woo_js' ), 10 );
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/others/recently-viewed-products/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/others/recently-viewed-products/';
                } else {
...
if( !function_exists('netlink_shop_others_recently_viewed_products') ) {
	function netlink_shop_others_recently_viewed_products() {
        $reflection = new ReflectionClass('Netlink_Shop_Others_Recently_Viewed_Products');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Netlink_Shop_Others_Recently_Viewed_Products::instance();