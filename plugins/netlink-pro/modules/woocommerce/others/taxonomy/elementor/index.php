...
class Netlink_Shop_Elementor_Taxonomy_Widgets {
	...
	function netlink_shop_register_widgets( $widgets_manager ) {
		...
		require netlink_shop_others_taxonomy()->module_dir_path() . 'elementor/widgets/product-cat/class-product-cat.php';
		$widgets_manager->register( new Netlink_Shop_Widget_Product_Cat() );

		require netlink_shop_others_taxonomy()->module_dir_path() . 'elementor/widgets/product-cat-single/class-product-cat-single.php';
		$widgets_manager->register( new Netlink_Shop_Widget_Product_Cat_Single() );
	...
	function netlink_shop_register_widget_styles( $suffix ) {
		...
		# Product Cat
			wp_register_style( 'wdt-shop-product-cat',
				netlink_shop_others_taxonomy()->module_dir_url() . 'assets/css/style'.$suffix.'.css',
				array()
			);
...
Netlink_Shop_Elementor_Taxonomy_Widgets::instance();