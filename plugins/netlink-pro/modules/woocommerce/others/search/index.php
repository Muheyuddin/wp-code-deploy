...
if( !class_exists( 'Netlink_Shop_Others_Search' ) ) {

    class Netlink_Shop_Others_Search {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/others/search/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/others/search/';
                } else {
         ...
         */
            function module_add_new_page_template( $templates ) {
                ...
                $templates = array_merge (
                    $templates,
                    array (
                        'tpl-product-search-listing.php' => esc_html__('Product Search Listing Template', 'netlink-pro')
                    )
                );
...
if( !function_exists('netlink_shop_others_search') ) {
	function netlink_shop_others_search() {
        $reflection = new ReflectionClass('Netlink_Shop_Others_Search');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Netlink_Shop_Others_Search::instance();