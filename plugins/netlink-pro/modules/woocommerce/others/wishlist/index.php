...
if( !class_exists( 'Netlink_Shop_Others_Wishlist' ) ) {

    class Netlink_Shop_Others_Wishlist {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/others/wishlist/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/others/wishlist/';
                } else {
...
if( !function_exists('netlink_shop_others_wishlist') ) {
	function netlink_shop_others_wishlist() {
        $reflection = new ReflectionClass('Netlink_Shop_Others_Wishlist');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Netlink_Shop_Others_Wishlist::instance();