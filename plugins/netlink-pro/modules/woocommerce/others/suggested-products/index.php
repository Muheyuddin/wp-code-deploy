...
if( !class_exists( 'Netlink_Shop_Others_Suggested_Products' ) ) {

    class Netlink_Shop_Others_Suggested_Products {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/others/suggested-products/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/others/suggested-products/';
                } else {
...
if( !function_exists('netlink_shop_others_suggested_products') ) {
	function netlink_shop_others_suggested_products() {
        $reflection = new ReflectionClass('Netlink_Shop_Others_Suggested_Products');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Netlink_Shop_Others_Suggested_Products::instance();