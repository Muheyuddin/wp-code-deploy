...
if( !class_exists( 'Netlink_Shop_Others_Size_Guide' ) ) {

    class Netlink_Shop_Others_Size_Guide {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/others/size-guide/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/others/size-guide/';
                } else {
...
if( !function_exists('netlink_shop_others_size_guide') ) {
	function netlink_shop_others_size_guide() {
        $reflection = new ReflectionClass('Netlink_Shop_Others_Size_Guide');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Netlink_Shop_Others_Size_Guide::instance();