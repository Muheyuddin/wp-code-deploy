...
if( !class_exists( 'Netlink_Shop_Others_Cart' ) ) {

    class Netlink_Shop_Others_Cart {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/others/cart/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/others/cart/';
                } else {
...
if( !function_exists('netlink_shop_others_cart') ) {
	function netlink_shop_others_cart() {
        $reflection = new ReflectionClass('Netlink_Shop_Others_Cart');
        return $reflection->newInstanceWithoutConstructor();
	}
}

Netlink_Shop_Others_Cart::instance();