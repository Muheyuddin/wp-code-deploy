...
if( ! function_exists( 'netlink_shop_woo_loop_product_custom_type' ) ) {

	function netlink_shop_woo_loop_product_custom_type($product_id) {
        ...
        if( $product_show_custom_type ) {
            ...
            if(isset($settings['custom-product-type']) && $settings['custom-product-type'] != '') {
                ...
                $woo_others_settings = netlink_woo_others()->woo_default_settings();
    ...
    add_action( 'netlink_woo_before_product_thumb_image', 'netlink_shop_woo_loop_product_custom_type', 10, 1 );
