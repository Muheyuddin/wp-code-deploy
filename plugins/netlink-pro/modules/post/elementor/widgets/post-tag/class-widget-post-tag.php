...
class Elementor_Post_Tags extends NetlinkElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Tags', 'netlink-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-tags-wrapper '.$style.' '.$el_class.'">';
            $out .= netlink_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/tag', '', $template_args );
		$out .= '</div>';
