...
class Elementor_Post_Socials extends NetlinkElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Socials', 'netlink-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-social-share-wrapper '.$style.' '.$el_class.'">';
			$out .= netlink_get_template_part( 'post', 'templates/post-extra/social', '', $template_args );
		$out .= '</div>';
