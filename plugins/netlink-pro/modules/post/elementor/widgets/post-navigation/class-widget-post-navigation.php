...
class Elementor_Post_Navigation extends NetlinkElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Navigation', 'netlink-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-post-navigation-wrapper '.$el_class.'">';
            $out .= netlink_get_template_part( 'post', 'templates/post-extra/navigation', '', $template_args );
		$out .= '</div>';
