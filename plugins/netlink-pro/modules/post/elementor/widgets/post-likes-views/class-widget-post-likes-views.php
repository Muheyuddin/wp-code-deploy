...
class Elementor_Post_Likes_Views extends NetlinkElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Likes & Views', 'netlink-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-likes-views-wrapper '.$style.' '.$el_class.'">';
            $out .= netlink_get_template_part( 'post', 'templates/post-extra/likes_views', '', $template_args );
		$out .= '</div>';
