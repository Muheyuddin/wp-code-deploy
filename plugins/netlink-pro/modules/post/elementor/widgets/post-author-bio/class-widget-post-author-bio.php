...
class Elementor_Post_Author_Bio extends NetlinkElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Author Bio', 'netlink-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-author-bio-wrapper '.$el_class.'">';
            $out .= netlink_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/author_bio', '', $template_args );
		$out .= '</div>';
