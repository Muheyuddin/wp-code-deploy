...
class Elementor_Post_Title extends NetlinkElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Title', 'netlink-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-title-wrapper '.$el_class.'">';
            $out .= netlink_get_template_part( 'post', 'templates/post-extra/title', '', $template_args );
		$out .= '</div>';
