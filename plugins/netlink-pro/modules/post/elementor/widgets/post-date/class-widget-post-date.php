...
class Elementor_Post_Date extends NetlinkElementorWidgetBase {
    ...
    public function get_title() {
        return esc_html__('Post - Date', 'netlink-pro');
    }
    ...
    protected function render() {
		...
		$out .= '<div class="entry-date-wrapper '.$style.' '.$el_class.'">';
            $out .= netlink_get_template_part( 'post', 'templates/'.$Post_Style.'/parts/date', '', $template_args );
		$out .= '</div>';
