...
if( !class_exists( 'Netlink_Woo_Listing_Shop' ) ) {

    class Netlink_Woo_Listing_Shop {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'netlink_woo_shop_page_default_settings', $this->settings );
...
if( !function_exists('netlink_woo_listing_shop') ) {
	function netlink_woo_listing_shop() {
		return Netlink_Woo_Listing_Shop::instance();
	}
}

netlink_woo_listing_shop();