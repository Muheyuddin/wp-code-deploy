...
if( !class_exists( 'Netlink_Shop_Single_Module_Upsell_Related' ) ) {

    class Netlink_Shop_Single_Module_Upsell_Related {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/single/modules/upsell-and-related/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/single/modules/upsell-and-related/';
                } else {
        ...
        */
            function woo_load_listing( $product_style_template, $product_style_custom_template ) {
                ...
                if( $product_style_template == 'predefined' ) {
                    $type_class_instance = 'netlink_woo_listing_type_'.$product_style_custom_template; // Type Class Instance
...
if( !function_exists('netlink_shop_single_module_upsell_related') ) {
	function netlink_shop_single_module_upsell_related() {
		return Netlink_Shop_Single_Module_Upsell_Related::instance();
	}
}

netlink_shop_single_module_upsell_related();