...
if( !class_exists( 'Netlink_Woo_Listing_Category' ) ) {

    class Netlink_Woo_Listing_Category {
        ...
        */
            ...
            function module_dir_path() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_DIR . '/woocommerce/category/';
                } else {
            ...
            function module_dir_url() {
                ...
                if( netlink_is_file_in_theme( __FILE__ ) ) {
                    return NETLINK_MODULE_URI . '/woocommerce/category/';
                } else {
        ...
        function woo_template_redirect() {
            ...
            if( is_product_category() ) {
                ...
                /* Define Sorter Settings */
                    add_filter( 'netlink_woo_sorter_settings', array( $this, 'woo_sorter_settings' ) );
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'netlink_woo_category_page_default_settings', $this->settings );
        ...
        */
            function woo_load_listing() {
                ...
                if( $this->settings['product_style_template'] == 'predefined' ) {
                    $type_class_instance = 'netlink_woo_listing_type_'.$this->settings['product_style_custom_template']; // Type Class Instance
                } else if( $this->settings['product_style_template'] == 'custom' ) {
                    $type_class_instance = 'netlink_woo_listing_type_custom'; // Type Class Instance
                }
...
if( !function_exists('netlink_woo_listing_category') ) {
	function netlink_woo_listing_category() {
		return Netlink_Woo_Listing_Category::instance();
	}
}

netlink_woo_listing_category();