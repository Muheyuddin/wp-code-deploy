...
if( !class_exists( 'Netlink_Woo_Others' ) ) {

    class Netlink_Woo_Others {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'netlink_woo_others_settings', $this->settings );
...
if( !function_exists('netlink_woo_others') ) {
	function netlink_woo_others() {
		return Netlink_Woo_Others::instance();
	}
}
