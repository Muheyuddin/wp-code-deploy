...
abstract class Netlink_Woo_Listing_Option_Core {
    ...
    */
        ...
        function module_dir_path() {
            ...
            if( netlink_is_file_in_theme( __FILE__ ) ) {
                return NETLINK_MODULE_DIR . '/woocommerce/listings/options/';
            } else {
        ...
        function module_dir_url() {
            ...
            if( netlink_is_file_in_theme( __FILE__ ) ) {
                return NETLINK_MODULE_URI . '/woocommerce/listings/options/';
            } else {
     ...
     */
        function render_frontend() {
            ...
            /* Options Class Names */
                add_filter( 'netlink_woo_listings_class', array( $this, 'woo_listings_class_load'), 10, 1 );
            ...
            if( $non_archive_listing ) {
                ...
                /* Options JS */
                    add_filter( 'netlink_woo_non_archive_js', array( $this, 'woo_listings_js_load'), 10, 1 );
                ...
                /* Options JS */
                    add_filter( 'netlink_woo_archive_js', array( $this, 'woo_listings_js_load'), 10, 1 );
            }
        ...
        function woo_listings_loop_prop() {
            ...
            if( in_array( 'html', $this->option_type ) ) {
                if( !empty ( $this->option_default_value ) ) {
                    ...
                    array_push( $netlink_shop_loop_prop, $this->option_slug );
                    wc_set_loop_prop('wdt-shop-loop-prop', $netlink_shop_loop_prop);
...
if( !function_exists('netlink_woo_listing_option_core') ) {
	function netlink_woo_listing_option_core() {
		return Netlink_Woo_Listing_Option_Core::instance();
	}
}