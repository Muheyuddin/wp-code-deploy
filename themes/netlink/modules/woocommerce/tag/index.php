...
if( !class_exists( 'Netlink_Woo_Listing_Tag' ) ) {

    class Netlink_Woo_Listing_Tag {
        ...
        */
            function woo_default_settings() {
                ...
                $this->settings = apply_filters( 'netlink_woo_tag_page_default_settings', $this->settings );
...
if( !function_exists('netlink_woo_listing_tag') ) {
	function netlink_woo_listing_tag() {
		return Netlink_Woo_Listing_Tag::instance();
	}
}

netlink_woo_listing_tag();